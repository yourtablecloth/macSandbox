...
MacSandbox Commercial License Agreement
Version 0.1 (DRAFT) — © 2026 Nam Jung Hyun (rkttu). All rights reserved.
...
1.1 "Licensed Software" means the source code and binaries of MacSandbox that
are authored by Licensor and made available in this repository, EXCLUDING any
third-party components listed in THIRD-PARTY-NOTICES.md (the "Third-Party
Components").

1.2 "Third-Party Components" means QEMU, wimlib, FreeRDP/WinPR, edk2 and their
dependencies, each licensed under its own terms (GPL/LGPL/Apache-2.0/BSD/etc.).
This Agreement does NOT grant any rights in the Third-Party Components beyond
those granted by their respective licenses.

## 2. Grant of License

2.1 Subject to payment of the applicable fees and compliance with this
...
2.2 This Agreement applies ONLY to the Licensed Software. The Third-Party
Components remain governed by their own licenses. In particular, GPL/LGPL
Third-Party Components (e.g., QEMU, wimlib) continue to be distributed under
the GPL/LGPL, and Licensee must comply with those licenses when redistributing
them (including providing corresponding source — see WRITTEN-OFFER.txt).

## 3. Restrictions

3.1 Licensee shall not remove or alter copyright, trademark, or license notices
of Licensor or of Third-Party Components.

3.2 The license scope (per-seat, per-product, per-organization, term, etc.) and
fees are defined in the applicable Order Form or purchase record. Absent an
Order Form, no commercial rights are granted.

3.3 This Agreement does not grant rights to Licensor's trademarks.

## 4. Ownership

The Licensed Software is licensed, not sold. Licensor retains all right, title,
and interest in the Licensed Software, except as expressly granted herein.
...
ANY LOSS OF PROFITS OR DATA, ARISING OUT OF OR RELATED TO THIS AGREEMENT.
LICENSOR'S TOTAL LIABILITY SHALL NOT EXCEED THE FEES PAID BY LICENSEE.
